...
fwrite(humpairs, "~/Desktop/pgltoolswork/new_updated/filt.bins.humans.bedPE", quote = FALSE, sep = "\t", col.names = TRUE, row.names=FALSE)
fwrite(chimpairs, "~/Desktop/pgltoolswork/new_updated/filt.bins.chimps.bedPE", quote = FALSE, sep = "\t", col.names = TRUE, row.names=FALSE)
```
...
CTCF.humans <- read.csv("~/Desktop/pgltoolswork/new_updated/intersects/hg38.CTCF.notispan.bed", sep="\t", header=FALSE)
CTCF.chimps <- read.csv("~/Desktop/pgltoolswork/new_updated/intersects/pt5.CTCF.notispan.bed", sep="\t", header=FALSE)
...
HK27.bin1 <- read.csv("~/Desktop/pgltoolswork/new_updated/intersects/H3K27me3_bin1.bed", sep="\t", header=FALSE)
HK27.bin2 <- read.csv("~/Desktop/pgltoolswork/new_updated/intersects/H3K27me3_bin2.bed", sep="\t", header=FALSE)

...
full.data <- fread("~/Desktop/final.10kb.homer.df", header=TRUE, stringsAsFactors = FALSE, data.table=FALSE)
...
heatmaply(corheat4, main="Pairwise Pearson Correlation @ 10kb | 4", k_row=2, k_col=2, symm=TRUE, margins=c(50, 50, 30, 30))
